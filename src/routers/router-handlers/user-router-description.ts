...
export class UsersHandler {
    ...
    constructor(protected usersCommandService:UsersCommandService, protected usersQueryService:UsersQueryService) {
    }
    ...
    public createNewUser = async (req: Request, res: Response) => {
        ...
        if (insertedId) {
            ...
            const result = await this.usersQueryService.findSingleUser(insertedId);
    ...
    public deleteUser = async (req: Request, res: Response) => {
        ...
        const userId: string = typeof req.params[IdParamName.UserId] === 'string' ? req.params[IdParamName.UserId] : req.params[IdParamName.UserId][0];
        const result = await this.usersCommandService.deleteUser(
            userId,
        );
