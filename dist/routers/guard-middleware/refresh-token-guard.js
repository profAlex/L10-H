...
class RefreshTokenGuard {
    constructor(sessionsCommandRepository) {
        ...
        this.refreshTokenGuard = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                sessionId = yield this.sessionsCommandRepository.findSession(decodedRefreshTokenData === null || decodedRefreshTokenData === void 0 ? void 0 : decodedRefreshTokenData.userId, decodedRefreshTokenData === null || decodedRefreshTokenData === void 0 ? void 0 : decodedRefreshTokenData.deviceId, expToPass, iatToPass);
                // if (sessionId) {
