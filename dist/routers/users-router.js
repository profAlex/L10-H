...
exports.usersRouter.get("/", base64_auth_guard_middleware_1.superAdminGuardMiddleware, (0, pagination_validators_1.inputPaginationValidatorForUsers)(fields_for_sorting_1.UsersSortListEnum), error_management_validation_middleware_1.inputErrorManagementMiddleware, composition_root_1.usersHandler.getSeveralUsers);
exports.usersRouter.post("/", base64_auth_guard_middleware_1.superAdminGuardMiddleware, UserInputModel_validation_middleware_1.userInputModelValidation, error_management_validation_middleware_1.inputErrorManagementMiddleware, composition_root_1.usersHandler.createNewUser);
exports.usersRouter.delete(`/:${id_names_1.IdParamName.UserId}`, // было просто :id
base64_auth_guard_middleware_1.superAdminGuardMiddleware, validateUserId, error_management_validation_middleware_1.inputErrorManagementMiddleware, composition_root_1.usersHandler.deleteUser);
